...
@pytest.mark.login_guest    # группируем тесты, чтобы удобно было вызывать вместе в командной строке по "-m login_guest"
class TestLoginFromMainPage():  # объединяем в класс
